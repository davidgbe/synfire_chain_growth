...
M = Generic(
    ...
    I_SINGLE_FR_TRIALS=(11000, 11001),
    POP_FR_TRIALS=(11000, 11001),
    E_STDP_START=10,
...
S = Generic(RNG_SEED=args.rng_seed[0], DT=0.22e-3, T=50e-3, EPOCHS=10000)
    ...
    for rp_idx in range(repeats):
        ...
        for d_idx, dropout in enumerate(dropouts):
            ...
            for i_e in range(epochs):
                ...
                axs[0].set_xlim(m.INPUT_DELAY * 1000, 50)
