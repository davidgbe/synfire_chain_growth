...
parser.add_argument('--w_e_e_scale_down_factor', metavar='wee', type=float, nargs=1)
parser.add_argument('--w_e_i_scale_down_factor', metavar='wei', type=float, nargs=1)
...
M = Generic(
    ...
    W_E_E_SCALE_DOWN_FACTOR=args.w_e_e_scale_down_factor[0],
    W_E_I_SCALE_DOWN_FACTOR=args.w_e_i_scale_down_factor[0],
    SCALE_DOWN_PROB=0.5,
...
S = Generic(RNG_SEED=args.rng_seed[0], DT=0.2e-3, T=180e-3, EPOCHS=5000)
