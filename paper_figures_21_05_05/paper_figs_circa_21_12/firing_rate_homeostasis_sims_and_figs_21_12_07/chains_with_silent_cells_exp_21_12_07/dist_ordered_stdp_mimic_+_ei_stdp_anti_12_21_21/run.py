                ...
                if i_e > 0:
                    ...
                    if i_e >= m.E_STDP_START:
                        ...
                        for i_t in range(spks_for_e_cells.shape[0]):
                            ...
                            sparse_spks_i_plus = csc_matrix(spks_for_i_cells[stdp_start_ei:i_t, :])
                            sparse_spks_i_minus = csc_matrix(spks_for_i_cells[i_t:stdp_end_ei, :])
                            ...
                            trimmed_kernel_ei_plus = m.KERNEL_PAIR_EI[M.CUT_IDX_TAU_PAIR_EI - (i_t - stdp_start_ei):M.CUT_IDX_TAU_PAIR_EI]
                            trimmed_kernel_ei_minus = m.KERNEL_PAIR_EI[M.CUT_IDX_TAU_PAIR_EI:M.CUT_IDX_TAU_PAIR_EI + (stdp_end_ei - i_t)]
