...
S = Generic(RNG_SEED=args.rng_seed[0], DT=0.2e-3, T=160e-3, EPOCHS=4000)
    ...
    for i_e in range(epochs):
        ...
        if i_e > 0:
            ...
            if m.HETERO_COMP_MECH == 'firing_rate':
                ...
                e_diffs[np.logical_and(e_diffs <= 1, e_diffs >= 0)] = 0
                ...
                fr_update_e = sigmoid_transform_e_diffs.reshape(sigmoid_transform_e_diffs.shape[0], 1) * np.ones((m.N_EXC, m.N_EXC + m.N_UVA)).astype(float)
