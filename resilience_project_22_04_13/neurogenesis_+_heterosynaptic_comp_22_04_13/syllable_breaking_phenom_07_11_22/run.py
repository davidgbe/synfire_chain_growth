...
S = Generic(RNG_SEED=args.rng_seed[0], DT=0.05e-3, T=180e-3, EPOCHS=600)
...
def run_test(m, output_dir_name, n_show_only=None, add_noise=True, dropout={'E': 0, 'I': 0},
    ...
    for i_e in range(epochs):
        ...
        if i_e > m.DROPOUT_ITER:
            if i_e % 50 == 0:
                w_r_copy['E'][:m.N_EXC, :m.N_EXC] += 0.05 * w_r_copy['E'][:m.N_EXC, :m.N_EXC]
