...
M = Generic(
    ...
    SETPOINT_MEASUREMENT_PERIOD=(30, 60),
)
...
def gen_continuous_network(size, m):
    ...
    mat = np.where(active_inactive_pairings, 1.3 * w * exp_if_pos(cont_idx_dists, 5), gaussian_if_under_val(0.05, (size, size), 0.05 * w, 0.005 * w))
