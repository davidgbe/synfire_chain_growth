        ...
        for d_idx, dropout in enumerate(dropouts):
            ...
            for i_e in range(epochs):
                ...
                if i_e == 0:
                    ...
                    diffs = e_cell_fr_setpoint - np.sum(rsp.spks[:, :m.N_EXC] > 0, axis=0)
                    diffs[diffs < 0] = 0

                    w_r['E'][:m.N_EXC, :m.N_EXC] += (1e-1 * diffs / e_cell_fr_setpoint * w_r['E'][:m.N_EXC, :m.N_EXC])
