...
class LIFNtwkG(object):
    ...
    def update_w(self, t_ctr, spks, dt):
        ...
        fr_homeo_update = self.alpha * (self.fr_set_points - curr_spks)
        fr_homeo_update = fr_homeo_update.reshape(fr_homeo_update.shape[0], 1)
        ...
        weight_update = self.eta * (delta_stdp + fr_homeo_update - self.epsilon * theta_out)
